...
<head>
    ...
    <title>Register - The Stitch House</title>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#username').on('input', function () {
                ...
                if (username.length > 0) {
                    if (username.length < 3) {
                        ...
                        $(this).parent().after('<div class="invalid-feedback">Username must be at least 3 characters long.</div>');
                    } else if (!usernameRegex.test(username)) {
                        $(this).addClass('is-invalid');
                        $(this).siblings('.invalid-feedback').remove();
                        $(this).parent().after('<div class="invalid-feedback">Username can only contain letters, numbers, and underscores.</div>');
                    } else {
            ...
            $('#registerForm').on('submit', function (e) {
                ...
                // Form will submit normally to backend/register.php
            });
